package com.ura.taip.client;

import com.ura.taip.error.TAipError;
import com.ura.taip.http.TAipHttpClient;
import com.ura.taip.http.TAipRequest;
import com.ura.taip.http.TAipResponse;
import com.ura.taip.util.TAipClientConfiguration;
...
public abstract class BaseClient {
  ...
  protected String requestServer(TAipRequest request) {
    ...
    if (resStatus != 200) {
      return TAipError.APISERVICE_ERROR.toJsonResult("接口服务异常  耗时(毫秒):" + timeStamp + " HTTP STATUS:" + resStatus + " 请联系腾讯AI的官方人员");
    } else {
