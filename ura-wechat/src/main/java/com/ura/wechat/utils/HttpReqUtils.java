...
import com.ura.wechat.model.media.MpVideoMedia;
import com.ura.wechat.model.media.UploadMediasResult;
import com.ura.wechat.model.media.UploadNewsMedia;
    ...
    private static String defaultConnection(String method, String path, int timeout, int readTimeout, String data, String encoding)
        ...
        if (url != null) {
            ...
            if (conn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                result = SysIOUtils.inputStreamToString(input, encoding);
                conn.disconnect();
            }
        }
        return result;
            ...
            if (MapUtils.isNotEmpty(map)) {
                ...
                for (Map.Entry<String, String> entry : params) {
                    ...
                    if (charset != null && !"".equals(charset)) {
                        ...
                        builder.append(key).append("=").append(SysIOUtils.urlEncode(value, charset));
                    } else {
        ...
        try {
            if (conn != null) {
                ...
                if (contentType.equals("image/gif")) { // gif图片
                    ...
                    String str = SysIOUtils.inputStreamToString(input, encoding);
...
//        return ip;
    ...
    public static UploadMediasResult uploadTempMediaFile(String accessToken, String type, String path, String encoding) {
        ...
        try {
            ...
            result = JSONUtils.fromJsonString(json, UploadMediasResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return result;
    ...
    public static String uploadForeverMediaFile(String accessToken, String title, String introduction, String path, String encoding) {
        ...
        try {
            ...
            mediaId = JSONUtils.fromJsonString(json, "media_id");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return mediaId;
    ...
    public static UploadMediasResult uploadNewsMedia(String accessToken, List<UploadNewsMedia> entity, String encoding) {
        ...
        String json = HttpReqUtils.HttpsDefaultExecute(SystemConstant.POST_METHOD,
    ...
    public static String uploadImgMediaFile(String accessToken, String path, String encoding) {
        ...
        try {
            String json = HttpsUploadMediaFile(SystemConstant.POST_METHOD, WechatConfig.UPLOAD_IMG_MEDIA_URL, params,
                    path, encoding);
            url = JSONUtils.fromJsonString(json, "url");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return url;
    ...
    public static UploadMediasResult uploadMediaVideo(String accessToken, MpVideoMedia mpVideoMedia, String encoding) {
        ...
        params.put("access_token", accessToken);
        // post 提交的参数
        String data = JSONUtils.toJsonString(mpVideoMedia);
        String json = HttpReqUtils.HttpsDefaultExecute(SystemConstant.POST_METHOD, WechatConfig.UPLOAD_VIDEO_MEDIA_URL,
    ...
    public static String HttpsUploadMediaFile(String method, String path, Map<String, String> param, String mediaPath, String encoding)
        ...
        try {
            ...
            IOUtils.write(("\r\n--" + boundary + "--\r\n").getBytes(SystemConstant.DEFAULT_CHARACTER_ENCODING), output);
            output.flush();
            result = SysIOUtils.inputStreamToString(con.getInputStream(), encoding);
        } catch (IOException e) {
    ...
    public static String HttpsUploadMedia(String method, String path, Map<String, String> param, String mediaPath,
        ...
        try {
            ...
            if (mediaUrl != null) {
                ...
                // 获取输入流
                result = SysIOUtils.inputStreamToString(conn.getInputStream(), encoding);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
