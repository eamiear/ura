...
public class SignatureUtils {
    ...
    public static boolean checkSignature(String signature, String timestamp, String nonce){
        ...
        buffer = null;
        return tmpStr != null && tmpStr.equals(signature.toLowerCase());
    }
    ...
    private static String byteToStr(byte[] byteArray){
        ...
        for (byte b :
                byteArray) {
            strDigit.append(byteToHexStr(b));
        }
    ...
    public static String createSign(Object o, String apiKey, String encoding){
        ...
        result = MD5Utils.MD5Encode(result, encoding).toUpperCase();
        return result;
    }
     ...
     * @throws SAXException
     */
    public static boolean checkIsSignValidFromWeiXin(String checkXml, String apiKey, String encoding) throws ParserConfigurationException, IOException, SAXException{
        TreeMap<String, Object> map = XmlUtils.parseXmlToTreeMap(checkXml, encoding);
        ...
        if (!Objects.equals(signFromResultXml, signForAPIResponse)){// 签名验不过，表示这个API返回的数据有可能已经被篡改了
            return false;
        }
        return true;
    }
